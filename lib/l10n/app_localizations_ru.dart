...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get spotStructInflow =>
      'Рядом впадает река или ручей — течение несёт корм и кислород, перспективная точка, особенно в жару.';

  @override
  String get spotStructReeds =>
      'У берега здесь тростник или болото — укрытие и кормовая база для карпа.';

  @override
  String get spotStructDam =>
      'Рядом плотина или дамба — резкий перепад глубин, классическая точка.';
  ...
  String spotStructIslands(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'На водоёме несколько островов — у них часто держится рыба: структура, перепад глубин, укрытие.',
      one:
          'На водоёме есть остров — у островов часто держится рыба: структура, перепад глубин, укрытие.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get tabTips => 'Советы';

  @override
  String get tipsNext => 'Ещё совет';

  @override
  String get tipLocationFirstTitle => 'Место решает больше, чем насадка';

  @override
  String get tipLocationFirstBody =>
      'Самая частая ошибка новичка — приехать и забросить «в никуда». Опытные карпятники единодушны: знать, ГДЕ стоит рыба, важнее, чем ЧЕМ её ловить — в неправильном месте не выручит ни одна насадка. Час на поиск кормящейся рыбы (всплески, цепочки пузырей, рыба у поверхности) окупается сильнее, чем 10 часов вслепую за сигнализаторами. Сначала 15–20 минут наблюдай за водой — потом ставь снасти.';

  @override
  String get tipLocationFirstProof =>
      'Умение читать воду карповые издания называют главным преимуществом: «в неправильном месте не поймаешь, точка».';

  @override
  String get tipMarginsTitle => 'Лови у берега — самый недооценённый приём';

  @override
  String get tipMarginsBody =>
      'Большинство бьёт как можно дальше и игнорирует воду под ногами. А карп патрулирует прибрежную бровку каждый день и ночь — на любом водоёме. Известный кейс: ловившие у берега брали вдвое больше тех, кто бил в середину. Бонус — рыбу видно, можно подать насадку конкретной особи и учиться на её поведении. Подходи к урезу тихо.';

  @override
  String get tipMarginsProof =>
      'Ловлю «в маржа / edge» гайды относят к самым недооценённым карповым тактикам.';

  @override
  String get tipSharpHooksTitle => 'Тупой крючок — потерянная рыба';

  @override
  String get tipSharpHooksBody =>
      'То, что новички упускают чаще всего. Разница между острым и бритвенно-острым крючком огромна: больше касаний переходит в поклёвки, больше поклёвок — в надёжные засечки. Крючок тупится не только о камни и ракушку, но даже просто лёжа на дне. Проверяй жало перед КАЖДЫМ забросом (ногтевой тест) и меняй при малейшем затуплении.';

  @override
  String get tipSharpHooksProof =>
      'Эксперты сходятся: острота крючка резко снижает сходы и повышает реализацию поклёвок.';

  @override
  String get tipDontOverfeedTitle => 'Не перекорми точку';

  @override
  String get tipDontOverfeedBody =>
      'Вторая классическая ошибка. Избыток корма растаскивает рыбу по большой площади и уводит от оснастки, а сытому карпу твоя насадка не нужна. Лучше «мало, но точно» — небольшие порции в одну точку. Перекорм — частая причина пустого дня, даже когда рыба рядом.';

  @override
  String get tipDontOverfeedProof =>
      '«Перекорм» — один из первых пунктов в списках типичных ошибок.';

  @override
  String get tipBaitRegularlyTitle => 'Регулярность закорма важнее объёма';

  @override
  String get tipBaitRegularlyBody =>
      'Если можешь — закармливай точку заранее и часто. По 1 кг каждый день работает лучше, чем 5 кг раз в 5 дней. Постоянство приучает карпа возвращаться за «бесплатной едой» без опаски — и когда ставишь оснастку, поклёвки уверенные. Держись одной насадки в кампании: рыба учится искать именно её и часто «зацикливается».';

  @override
  String get tipBaitRegularlyProof =>
      'Бейт-компании и гайды по прикармливанию единодушны: ключ — регулярность, «меньше, но чаще».';

  @override
  String get tipHairRigTitle => 'Волосяная оснастка — почему она ловит';

  @override
  String get tipHairRigBody =>
      'Карп не глотает сразу: он пробует насадку — всасывает и выплёвывает. На самом крючке он чувствует металл и выплёвывает его вместе с насадкой. На «волосе» насадка отдельно от голого крючка: при всасывании крючок свободно заходит в рот и цепляет нижнюю губу. С 1980-х этот принцип кардинально поднял реализацию и стал основой современной ловли.';

  @override
  String get tipHairRigProof =>
      'Классика, проверенная десятилетиями; принцип «всасывания» — база всех современных монтажей.';

  @override
  String get tipSweetcornTitle => 'Кукуруза — дёшево и убойно';

  @override
  String get tipSweetcornBody =>
      'Сладкая кукуруза ловит по всему миру: яркая, сладкая, мягкая и богата аминокислотами — карп воспринимает её как естественную еду. И это копейки: тот же вес бойлов стоит в разы дороже. Особенно «мгновенно» срабатывает там, где карп кормится в основном природным кормом.';

  @override
  String get tipSweetcornProof =>
      'Кукурузу называют одной из самых доступных и эффективных насадок; разница в цене с бойлами — в десятки раз.';

  @override
  String get tipMixedSizesTitle => 'Смешивай размер насадки';

  @override
  String get tipMixedSizesBody =>
      'Мешай калибры бойлов (например 12–15 мм и 18–22 мм): карп не может «подстроиться» под один размер и осторожничать — шанс взять именно крючковую насадку растёт. Мелкая — для зимы и запрессованных водоёмов, крупная — против мелочи и под трофей.';

  @override
  String get tipMixedSizesProof =>
      '«Смешанные размеры» — стандартный приём, чтобы сбить избирательность рыбы.';

  @override
  String get tipFallingPressureTitle => 'Падающее давление — окно жора';

  @override
  String get tipFallingPressureBody =>
      'Перед приходом фронта, когда давление падает, рыба часто кормится активнее. Карп реагирует мягче хищника (донный, менее чувствителен), но карпятники отмечают: на низком давлении он кормится дольше и охотнее. Лучшее окно — за 6–12 часов до фронта. Важно: «магической» цифры давления нет — работает именно ТРЕНД на снижение, а не конкретное значение.';

  @override
  String get tipFallingPressureProof =>
      'Журнальные наблюдения фиксировали рост активности до ~40% на падающем давлении; при этом самое цитируемое исследование (1983, окунь) дало лишь слабую корреляцию — поэтому честнее про тренд, чем про гарантию.';

  @override
  String get tipCrucianShyBitesTitle =>
      'Карась — осторожный дегустатор: топи антенну';

  @override
  String get tipCrucianShyBitesBody =>
      'Поклёвка карася бывает едва заметной — четверть притопления тонкой антенны. Торчит много антенны — не увидишь деликатных тычков. Огрузи поплавок «в точку», оставив минимум над водой. Карась выплёвывает насадку, едва почувствовав сопротивление, — всё должно быть лёгким и чувствительным.';

  @override
  String get tipCrucianShyBitesProof =>
      'Карасёвые гайды единодушны: «топи антенну»; тонкая антенна решает регистрацию робких поклёвок.';

  @override
  String get tipCrucianFineTackleTitle => 'Карась: тонко и мелко';

  @override
  String get tipCrucianFineTackleBody =>
      'Толстая леска и крупные крючки — табу. Тонкий, но прочный крючок малого размера: №18–20 под опарыша/кастер, №16 под кукурузу/пеллетс. Не перекармливай (налетят линь и лещ): начни с прикормочных шаров размером с мяч для гольфа и пары насадочных зёрен, добавляй только если активно клюёт.';

  @override
  String get tipCrucianFineTackleProof =>
      'Стандарт по карасю — тонкая снасть, мелкий крючок, дозированный закорм.';

  @override
  String get tipCrucianSlowFallTitle => 'Карась берёт на падении';

  @override
  String get tipCrucianSlowFallBody =>
      'Часто поклёвка случается, когда насадка медленно опускается. Распредели мелкие дробинки равномерно (медленное падение) и подвесь последнюю крошечную дробинку-индикатор в 5–7 см от крючка — она быстро покажет робкую поклёвку.';

  @override
  String get tipCrucianSlowFallProof =>
      '«Медленное падение» плюс сигнальная дробинка у крючка — типичный приём под карася.';

  @override
  String get tipWaterTempTitle => 'Вода важнее календаря';

  @override
  String get tipWaterTempBody =>
      'Карп холоднокровен — аппетит привязан к температуре ВОДЫ, а не к дате. Пик активности ~18–24 °C; ниже ~10 °C обмен веществ замедляется, и рыба почти перестаёт кормиться. На практике: в холодной воде ставь мелкую насадку и лови в дневной прогрев на мелководье; в жару — ночь и зорьки. Не жди жора в ледяной воде в полдень.';

  @override
  String get tipWaterTempProof =>
      'Биология карповых: метаболизм прямо зависит от температуры воды — поэтому зимой клёв резко падает.';

  @override
  String get tipPvaBagTitle => 'ПВА-пакет — горсть корма у крючка';

  @override
  String get tipPvaBagBody =>
      'Растворимый ПВА-пакет с пеллетсом или крошкой, надетый на крючок, кладёт аккуратную кучку корма ровно туда, где ложится насадка. Он тает за минуты, оставляя привлекательное пятно и распутанную оснастку после заброса. Особенно выручает на иле и в траве, где одиночная насадка теряется, — карп находит «стол» и кормится прямо на оснастке.';

  @override
  String get tipPvaBagProof =>
      'ПВА-снасти — стандарт современной карповой ловли для точной подачи корма к крючку.';

  @override
  String get tipFeatureFindingTitle => 'Найди рельеф — карп ходит по бровкам';

  @override
  String get tipFeatureFindingBody =>
      'Рыба не размазана равномерно — она держится у структур: бровок, перепадов глубины, твёрдого дна среди ила, кромки травы, коряг. Перед ловлей «прощупай» дно грузом: волочи его и чувствуй, как меняется грунт, считай глубину по падению. Заброс на найденную бровку бьёт случайный заброс «на дальность».';

  @override
  String get tipFeatureFindingProof =>
      'Поиск рельефа маркером или грузом — базовый навык карпятника: карп патрулирует структуры, а не открытую пустоту.';

  @override
  String get tipStayQuietTitle => 'Тишина на берегу — карп пуглив';

  @override
  String get tipStayQuietBody =>
      'Карп чувствует вибрации боковой линией и «слышит» телом. Топот по берегу, хлопанье дверьми, грохот по лодке, тяжёлый заброс под ноги — и рыба уходит с мелководья и из-под берега. Подходи к воде тихо, не свети на поверхность, ставь снасти аккуратно. Особенно важно при ловле у берега и на мели.';

  @override
  String get tipStayQuietProof =>
      'Боковая линия карпа ловит малейшее движение — громкий шум реально настораживает рыбу.';

  @override
  String get tipParticlesTitle => 'Частицы (конопля) удерживают стаю';

  @override
  String get tipParticlesBody =>
      'Мелкий корм вроде конопли создаёт пятно, заставляя карпа рыться и кормиться в одной точке, не насыщаясь быстро, — рыба задерживается над оснасткой. Важно про безопасность: сухие частицы (особенно тигровый орех и бобовые) перед ловлей обязательно замачивать И варить до готовности — недоваренные могут навредить рыбе.';

  @override
  String get tipParticlesProof =>
      'Конопля — классика для удержания стаи; правильная подготовка частиц — общеизвестное правило безопасности для рыбы.';

  @override
  String get tipFishCareTitle => 'Береги рыбу — она ещё клюнет';

  @override
  String get tipFishCareBody =>
      'Трофейный карп растёт десятилетиями и может клюнуть снова — если выпустить его здоровым. Мокрые руки и мокрый мат или трава, минимум времени без воды, не клади рыбу на сухой песок или камни, аккуратно сними крючок (ещё повод держать его острым). Фото — низко над матом и быстро. Здоровый отпущенный карп — будущая поклёвка для тебя и других.';

  @override
  String get tipFishCareProof =>
      'Принципы catch & release у карпятников: бережное обращение сохраняет популяцию и твои будущие поимки.';

  @override
  String get tipCrucianWarmShallowsTitle => 'Карась — на прогретом мелководье';

  @override
  String get tipCrucianWarmShallowsBody =>
      'Карась любит тепло и заросли. Весной и в начале лета он первым выходит кормиться на прогретое мелководье — мелкие заливы, у камыша и кувшинок, где вода теплее на пару градусов. Ищи тихие, заросшие, хорошо прогреваемые участки; на глубине в это время карася почти нет. Чем теплее вода, тем активнее карась.';

  @override
  String get tipCrucianWarmShallowsProof =>
      'Карась — теплолюбивая рыба зарослей; ранний прогрев мелководья объясняет, почему он там кормится первым.';

  @override
  String get fcAlgoFactsTitle => 'Интересное об алгоритме';

  @override
  String get fcAlgoFactLabel => 'Факт дня';

  @override
  String get algoFactWaterModelTitle => 'Считаем по воде, а не по воздуху';

  @override
  String get algoFactWaterModelBody =>
      'Карп живёт в воде, а она прогревается с задержкой. Мы не берём температуру воздуха напрямую — а моделируем температуру воды через уравнение теплообмена, как остывающую чашку чая.';

  @override
  String get algoFactThermalInertiaTitle =>
      'У каждого водоёма своя тепловая инерция';

  @override
  String get algoFactThermalInertiaBody =>
      'Речка отзывается на погоду за пару дней, пруд — медленнее, а большое водохранилище раскачивается неделями. Поэтому скорость прогрева мы подбираем под тип и площадь водоёма.';

  @override
  String get algoFactPressureTrendTitle => 'Важно не давление, а его тренд';

  @override
  String get algoFactPressureTrendBody =>
      'Лучший клёв — не при «хорошем» давлении, а при плавном падении перед фронтом. Резкий обвал и резкий скачок мы, наоборот, штрафуем. Смотрим тренд и за 6, и за 24 часа.';

  @override
  String get algoFactFrontMemoryTitle => 'Помним о прошедшем фронте ещё сутки';

  @override
  String get algoFactFrontMemoryBody =>
      'Даже когда давление уже выправилось, рыба ещё в шоке после холодного фронта. Мы держим отдельный штраф на сутки — карп отходит один-два дня.';

  @override
  String get algoFactWeakestLinkTitle => 'Принцип слабого звена';

  @override
  String get algoFactWeakestLinkBody =>
      'Многие калькуляторы просто складывают баллы — и хорошее давление «вытягивает» ледяную воду. У нас температура, сезон и давление работают как предохранители: мёртвую воду не спасёт идеальный ветер.';

  @override
  String get algoFactHeatCalmTitle => 'Штраф за жару вместе со штилем';

  @override
  String get algoFactHeatCalmBody =>
      'Понижение включается, только когда жара и штиль совпали, — именно тогда воде не хватает кислорода. По отдельности жаркий день или безветрие не так страшны.';

  @override
  String get algoFactRealSunTitle => 'Зорьки — по реальному солнцу';

  @override
  String get algoFactRealSunBody =>
      'Никаких фиксированных «клёв в 6 утра». Мы берём настоящее время восхода и заката для вашей точки, усиливаем утреннюю и вечернюю зорьку, а жаркий полдень приглушаем.';

  @override
  String get algoFactSpawnPhysicsTitle =>
      'Нерест — по физике, а не по календарю';

  @override
  String get algoFactSpawnPhysicsBody =>
      'Фазу нереста мы вычисляем по температуре воды и длине светового дня для вашей широты. И честно показываем уверенность: на медленном водоёме сигнал размыт.';

  @override
  String get algoFactSpeciesModelsTitle => 'Карп и карась — две разные модели';

  @override
  String get algoFactSpeciesModelsBody =>
      'Это не одна формула с галочкой. У карася выше оптимум температуры, он чувствительнее к давлению, любит слабую рябь и почти не клюёт ночью — десятки параметров настроены под каждый вид.';

  @override
  String get algoFactBiteWindowsTitle => 'Окна клёва, а не просто часы';

  @override
  String get algoFactBiteWindowsBody =>
      'Мы собираем хорошие часы в непрерывные окна, перепрыгиваем одиночные провалы и правильно сшиваем окна, которые переходят через полночь.';
