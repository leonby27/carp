...
class BiteConfig {
  ...
  static const BiteConfig carp = BiteConfig(
    ...
    tempColdDormant: 4,
    // Источники: жор есть с 12–14 °C, но УВЕРЕННЫЙ — с ~16 °C, пик ~24 °C.
    // Нижний край оптимума = 16 (а не 14): на 14 кривая давала уже 0.85, из-за
    // чего прохладная вода 11–13 °C переоценивалась. Спад от жары — с 28.
    tempOptimumLow: 16,
    tempOptimumHigh: 24,
    tempHeatStress: 28,
    windBestLow: 2,
